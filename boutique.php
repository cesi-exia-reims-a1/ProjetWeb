...
<body>
	...
	<main>
		...
		<!-- Ligne avec filtre et recherche -->
		...
		<div class="container-fluid mt-3">
			...
			<!-- Carousel trois objets les plus vendus -->
			...
			<div id="carouselExampleIndicators" class="carousel slide container mb-5" data-ride="carousel">
				...
				<a class="fleche align-self-center carousel-control-prev" href="#carouselExampleIndicators"
					role="button" data-slide="prev">
					<span class="carousel-control-prev-icon" aria-hidden="true"></span>
					<span class="sr-only">Précedente</span>
				</a>
				<a class="fleche align-self-center carousel-control-next" href="#carouselExampleIndicators"
