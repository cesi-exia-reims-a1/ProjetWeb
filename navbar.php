<nav class="navbar navbar-expand-lg navbar-light" style="background-color: white;">
	<a class="navbar-brand" href="index.php"><img
			src="https://montpellier.cesi.fr/wp-content/uploads/sites/25/2018/11/Cesi_Logo_INGENIEUR_RVB-360x213.png"
			width="90" height="52" alt=""></a>
	...
	<?php include 'displayTelechargerPhoto.php' ?>

		<?php
					if (isset($_SESSION['pseudo'])){?>
		<div class="ml-auto bd-highlight border border-secondary" id="panier" /><a href="panier.php"
			class="nav-item nav-link active text-dark">Panier</a></div>
	<?php } else {
	...
	<?php
					 if (!isset($_SESSION['pseudo'])){
						 ?>
						 <div class='ml-auto'>
	<div class='bd-highlight' /><a href='' class='btn btn-default btn-rounded' data-toggle='modal'
		data-target='#elegantModalForm'>Connexion</a></div></div>
